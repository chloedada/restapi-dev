package com.chloe.payment.security;
...
public class AESUtils {
	...
	public static void main(String[] args) throws Exception {
        ...
        String text = "111|2222|333";

        String enen = encrypt(text);
        String dede = decrypt(enen);

        System.out.println("평문데이터 : " + text);
        System.out.println("암호화된 값 : " + enen);
        System.out.println("복호화된 값 : " + dede);
    }
